...
class Weight(object):
    def __init__(self,omok):
        ...
        self.two_point = 2
        self.three_point = 10
        self.closed_four_point = 15
        self.four_point = 50
        self.omok_point = 200
        self.def_point = 0
        self.teki_two_point = 3
        self.teki_three_point = 70
        self.teki_closed_three_point = 9
        self.teki_four_point = 150
                                    ...
                                    if self.board[i+2*a,j+2*b] == 0:
                                        if self.board[i+3*a,j+3*b] == 0:
                                            ...
                                            if i+4*a <15 and i+4*a>=0 and j+4*b <15 and j+4*b>=0:
                                                ...
                                                self.weight[i+2*a,j+2*b] += self.closed_four_point#000001141
                                        ...
                                        if self.board[i+3*a,j+3*b] == 0:
                                            if i+4*a <15 and i+4*a>=0 and j+4*b <15 and j+4*b>=0:
                                                ...
                                                self.weight[i+3*a,j+3*b] += self.closed_four_point#000001114
                                        elif self.board[i+3*a,j+3*b] == self.turn:
                                            if self.board[i+4*a,j+4*b] == 0:
                                        ...
                                        if self.board[i+3*a,j+3*b] == 0:
                                            ...
                                            if i+4*a <15 and i+4*a>=0 and j+4*b <15 and j+4*b>=0:
                                                if self.board[i+4*a,j+4*b] == self.turn:
                                                    ...
                                                    self.weight[i+a,j+b] += self.closed_four_point#0001411-10
                                            else:
                                                self.weight[i+a,j+b] += self.closed_four_point#000001411
                                ...
                                if self.board[i+a,j+b] == self.turn:
                                    if self.board[i+2*a,j+2*b] == self.turn:
                                        if self.board[i+3*a,j+3*b] == self.turn:
                                            ...
                                            if self.board[i+4*a,j+4*b] == 0:
                                                self.weight[i+3*a,j+3*b] += self.closed_four_point#000-1111400
                                        ...
                                        if self.board[i+3*a,j+3*b] == self.turn:
                                            if self.board[i+4*a,j+4*b] == self.turn:
                                                ...
                                                self.weight[i+2*a,j+2*b] += self.closed_four_point#000-1114100
                                    ...
                                    if self.board[i+2*a,j+2*b] == self.turn:
                                        if self.board[i+3*a,j+3*b] == self.turn:
                                            if self.board[i+4*a,j+4*b] == self.turn:
                                                ...
                                                self.weight[i+a,j+b] += self.closed_four_point#000-1141100
                                ...
                                if self.board[i+a,j+b] == -self.turn:
                                    if self.board[i+2*a,j+2*b] == 0:
                                        ...
                                        if self.board[i+3*a,j+3*b] == 0:
                                            ...
                                            if self.board[i+4*a,j+4*b] == 0:
                                                self.weight[i+4*a,j+4*b] += self.teki_three_point+self.def_point#000511115
                                elif self.board[i+a,j+b] == 0:
                                    if self.board[i+2*a,j+2*b] == -self.turn:
                                        if self.board[i+3*a,j+3*b] == 0:
