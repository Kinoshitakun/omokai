...
class Omok(object):
    ...
    def set_image(self):
        ...
        self.Empty_text = self.font.render("                      ",True,bg_color)
        ...
        if pos:
            ...
            if self.board[x][y] == 0:
                ...
                if self.turn == 1:
                    ...
                    self.board[x][y] = 1
                    self.turn = -1
                    self.surface.blit(self.Empty_text,(550,50))
                else:
    ...
    def yukmok(self,pos):
        ...
        for coord in test_list_1:
            ...
            for l in range(-5,5):
                ...
                if x+l*a+1<14 and x+l*a+1>=0 and y+l*b+1<14 and y+l*b+1 >=0:
                    if self.board[x+l*a][y+l*b] == 1:
                        if self.board[x+l*a][y+l*b] == self.board[x+l*a+1][y+l*b+1]:
                            cnt += 1
                        else:
                            cnt = 0
                    else:
